...
class MyDataset(Dataset):
    def __init__(self, args, graphs, features, adjs,  context_pairs):
        ...
        #修改
        self.train_nodes = list(self.graphs[args.window_size - 1].nodes())
    ...
    def construct_degs(self):
        ...
        degs = []
        #修改
        for i in range(self.min_t, self.window_size):
            G = self.graphs[i]
            deg = []
    ...
    def __createitems__(self):
        self.data_items = {}
        #修改
        for node in list(self.graphs[self.window_size-1].nodes()):
            feed_dict = {}
            node_1_all_time = []
            node_2_all_time = []
            #修改
            for t in range(self.min_t, self.window_size):
                node_1 = []
                node_2 = []
